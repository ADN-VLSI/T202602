  ...
  function void connect_phase(uvm_phase phase);
    ...
    fork
      ...
      forever begin
        ...
        uart_intf.recv_tx(rsp_tx.data, rsp_tx.parity, rsp_tx.baud_rate, rsp_tx.parity_enable,
                          rsp_tx.parity_type, rsp_tx.second_stop_bit, rsp_tx.data_bits);
      ...
      forever begin
        ...
        uart_intf.recv_rx(rsp_rx.data, rsp_rx.parity, rsp_rx.baud_rate, rsp_rx.parity_enable,
                          rsp_rx.parity_type, rsp_rx.second_stop_bit, rsp_rx.data_bits);
